...
@swag_from('docs/place_amenity/get_id.yml', methods=['GET'])
...
@swag_from('docs/place_amenity/delete.yml', methods=['DELETE'])
...
@swag_from('docs/place_amenity/post.yml', methods=['POST'])
